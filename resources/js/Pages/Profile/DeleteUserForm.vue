    ...
    <jet-action-section>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Una volta che il tuo account è stato cancellato, tutte le risorse e i dati verrannno persi. Prima di eliminare il tuo account,  salva tutte le informazioni che ti servono.
            </div>
