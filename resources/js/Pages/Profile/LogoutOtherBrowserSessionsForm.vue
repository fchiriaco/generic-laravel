<template>
    <jet-action-section>
        ...
        <template #description>
            Gestisci e disconnetti le tue sessioni attive nei browser degli altri dispositivi
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Se necessario, puoi disconnettere tutte le sessioni su tutti i dispositivi. Le tue sessioni recenti sono di seguito elencate; Comunque, questa lista può non essere completa. Se ritieni che il tuo account è stato compromesso, ti suggeriamo di cambiare la password.
            </div>
            ...
            <div class="flex items-center mt-5">
                <jet-button @click="confirmLogout">
                    Disconnetti le sessioni sugli altri browser
                </jet-button>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Perfavore, inserisci la password per confermare che tu voglia realmente disconnettere le sessioni aperte su altri dispositivi.
